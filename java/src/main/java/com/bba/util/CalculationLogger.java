...
@Slf4j
public class CalculationLogger implements AutoCloseable {
    ...
    public void logItem(String title, String description, String formula, Map<String, Object> variables, Object result) {
        logItem(title, description, formula, variables, result, null);
    }
